...
$picturesFormHTML += '<div class="form-group">';
$picturesFormHTML += ' <button id="getPictures" type="submit" value="pictures">';
...
$usernameHTML += '<h1 class="main-header">FRIEND\'S</h1>';
$usernameHTML += '<h1 class="second-header-username">by username</h1>';
...
$favoritesHTML += '<p class="description lead">Keep up-to-date on your friends’ favorite pictures. Type in your friend’s userid and find their favorite photos.</p>';
$favoritesHTML += '</article>';
$favoritesHTML += '</section>';
