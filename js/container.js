...
$friendsPicsHTML += '</section>';
    ...
    // $friendsPicsFormHTML += '<span class="glyphicon glyphicon-search"> Search id </span>';
    ...
    $friendsPicsFormNameHTML += '<form class="navbar-form navbar-center" role="searchFriendsName">';
